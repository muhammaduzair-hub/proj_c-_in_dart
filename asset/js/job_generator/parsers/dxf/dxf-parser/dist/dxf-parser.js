        ...
        DxfParser.prototype._parse = function( dxfString )
        {
          ...
          var parseGroup = function()
          {
            ...
            while( curr.value !== 'EOF' )
            {
              ...
              {
                case 5:
                  group.handle = curr.value;
                  curr = scanner.peek();
                  break;
                case 70:
                  group.unnamed = !!curr.value;
                  curr = scanner.peek();
                  break;
                case 71:
                  group.selectable = !!curr.value;
                  curr = scanner.peek();
                  break;
                case 100:
                  // ignore class markers
                  ...
                  break;
                case 102:
                  // ignore reactors group
                  curr = scanner.peek();
                  break;
                case 300:
                  group.description = curr.value;
                  curr = scanner.peek();
                  break;
                case 330:
                  group.ownerHandle = curr.value;
                  curr = scanner.peek();
                  break;
                case 340:
                  if( !group.entityHandles )
                    group.entityHandles = [ ];
                  group.entityHandles.push( curr.value );
                  curr = scanner.peek();
                  break;
                default:
                  logUnhandledGroup( curr );
          ...
          while( curr !== 'EOF' )
          {
            ...
            switch( curr.code )
            {
              ...
              case 51: // end angle
                ...
                break;
              case 210:
                entity.normal.x = curr.value;
                break;
              case 220:
                entity.normal.y = curr.value;
                break;
              case 230:
                entity.normal.z = curr.value;
                break;
