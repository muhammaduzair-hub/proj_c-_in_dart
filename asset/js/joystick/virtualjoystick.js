var VirtualJoystick = function( opts )
{
  ...
  this._container.addEventListener( 'touchcancel', this._$onTouchEnd, false );
  ...
  this.yCorrection = $( this._container ).offset().top;
  this.xCorrection = $( this._container ).offset().left;
};
...
VirtualJoystick.prototype._onDown = function( x, y )
{
  ...
  if( this._stationaryBase == false )
  {
    this._baseX = x - this.xCorrection;
    this._baseY = y - this.yCorrection;
  ...
  this._stickX = x - this.xCorrection;
  this._stickY = y - this.yCorrection;
...
VirtualJoystick.prototype._buildJoystickBase = function()
{
  ...
  ctx.lineWidth = 6;
  ctx.arc( canvas.width / 2, canvas.width / 2, 56 / 2, 0, Math.PI * 2, true );
